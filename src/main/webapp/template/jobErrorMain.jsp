        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">JOB오류관리</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
						    ...
						    function drawGrid(data){
						        ...
						        $("#jobErrorGrid").jsGrid({
						            ...
						            , rowClick: function(arg){
						                jobErrorDetail(arg.item.jobErrorSn);
						            }
						            , fields : [
						                  {name: "cmpnyNm"          , title : "회사"             , type : "text"    , width : 80 , align : "center"}
						                ...
						                , {name: "managtTyNm"       , title : "현상태"          , type : "text"   , width : 80, align : "center"}
						            ]
						        });
