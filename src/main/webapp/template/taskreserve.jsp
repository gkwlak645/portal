        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">과제운영 예약실행</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <form class="form-inline" id="unmanagtErrorDetail"> 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control" style="width:70%;margin-right: 3px;" value="2020-08-06 15:00">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8 float-left">
                            <select id="" class="form-control float-left" style="width:30%;margin-right: 10px;">
                                   <option value="">BOT1</option>
                             </select>
                             <button type="button" id="btnSave"class="btn btn-outline-primary float-left" style="margin: 0;">예약정보등록</button>
                        </div>
                    </div>
