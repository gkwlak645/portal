        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Transaction오류관리 상세</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/main/siteMain">Home</a></li>
                                <li class="breadcrumb-item">모니터링/ Transaction오류관리</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
					            ...
					            <div class="col-md-12">
					                <form class="form-inline" id="trnscErrorDetail">
					                    ...
					                    <div class="form-group col-md-6">
					                        <label for="seDe" class="col-sm-4 col-form-label">구분날짜<b style="color: red;"> *</b></label>
					                        <div class="col-sm-8">
					                            <div class="input-group date" id="seDeDiv" data-target-input="nearest"style="width:80%;min-width:140px;">
					                                 <input type="text" id="seDe" name="seDe" class="form-control datetimepicker-input" data-target="#trnscErrorDetail #seDeDiv"/>
					                                 <div class="input-group-append" data-target="#trnscErrorDetail #seDe" data-toggle="datetimepicker" >
					                    ...
					                    <div class="form-group col-md-6 py-sm-2">
					                        <label for="occrrncCnt" class="col-sm-4 col-form-label">발생건수</label>
					                        <div class="col-sm-8">
					                            <input type="text" id="occrrncCnt" name=occrrncCnt class="form-control" maxlength="4" style="width:80%;" numberOnly2/>
					                        </div>
					                    </div>
					                    ...
					                    <div class="form-group col-md-6 py-sm-2">
					                        ...
					                        <div class="col-sm-8 float-left">
					                            ...
					                            <input type="text" id="sourcUpdtNm" class="form-control float-left" disabled class="form-control float-left" style="width:65%;margin-right:5px"  />
					                            <button type="button" class="btn btn-outline-primary float-left" id="btnSchSourcUpdtId">찾기</button>
					                        </div>
					                    </div>
					                    <div class="form-group col-md-6 py-sm-1">
					                        <label for="analsChargerNm" class="col-sm-4 col-form-label">분석담당자<b style="color: red;"> *</b></label>
					                        <div class="col-sm-8 float-left">
					                            <input type="hidden" id="analsChargerId" name="analsChargerId">
					                            <input type="text" id="analsChargerNm" class="form-control float-left" disabled  class="form-control float-left" style="width:65%;margin-right:5px" />
					                ...
					                <div class="py-sm-2 float-right">
					                    <button type="button" class="btn btn-primary" id="overTrnscErrorUnity">중복오류통합</button>
					                    <button type="button" class="btn btn-primary" id="trnscErrorSave">저장</button>
