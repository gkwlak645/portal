            ...
            <section class="content">
                <div id="content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="check_wrap">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="checkbox_confirm">1개 프로세스를 업그레이드할 수 있습니다.</label>
                                    </div>
                                    <ul class="check_wrap-drop">
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="checkbox1" checked>
                                                <label class="form-check-label" for="checkbox1">v1.0.3 - E_Robot_002</label>
                                            </div>
                                        </li>
                                    </ul>
                               </div>
                    ...
                    <script>
                            ...
                            /*
                            20201029 ja 체크박스 드롭다운 추가 
                            */
                            var chkBox = $("input:checkbox[id='checkbox_confirm']");
