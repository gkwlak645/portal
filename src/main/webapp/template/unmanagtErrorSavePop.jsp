					            ...
					            <div class="col-md-12">
					                <form class="form-inline" id="unmanagtErrorSave">
					                    ...
					                    <div class="form-group col-md-6 py-sm-2">
					                        ...
					                        <div class="col-sm-8">
					                            <select id="processCdPop" class="form-control" style="width:80%;">
					                                  <option value=""></option>
					                            </select>
					                    ...
					                    <div class="form-group col-md-6 py-sm-2">
					                        ...
					                        <div class="col-sm-8 float-left">
					                             <input type="text" id="opertTm" class="form-control float-left" style="width:25%;margin-right:5px;" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength=5/>시간
					                        </div>
					                    </div>
					                    <div class="form-group col-md-6 py-sm-2">
