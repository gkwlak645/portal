            ...
            <div class="col-md-12">
                <form class="form-inline" id="unmanagtErrorDetail">                    
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="1" id="" class="form-control" style="width:92.5%;" disabled></textarea>
                        </div>
                    </div>                   
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="" class="form-control"  style="width:92.5%;"disabled/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control"  style="width:80%;" value="H00101" disabled>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">회사</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control"  style="width:80%;" value="동원" disabled>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">부서</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">담당자</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">연락처</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control" style="width:120px;margin-right: 10px;" value="010-0000-0000" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="264" disabled>H
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">절감시간</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="264" disabled>H
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">예상절감금액</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="8,712,000" disabled>원
                        </div>
                    </div>
                    
                    <div class="form-group col-md-6">
                        <label for="" class="col-sm-4 col-form-label">실행주기</label>
                        <div class="col-sm-8">
                            <select id="" class="form-control float-left" style="width:30%;margin-right: 10px;" disabled>
                                <option value="">월</option>
                            </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="1" disabled>H
                        </div>
                    </div>     
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="10" disabled>일
                        </div>
                    </div>                    
                    <div class="form-group col-md-6">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">예상개발금액</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:120px;margin-right: 3px;" value="2,805,000" disabled>원
                        </div>
                    </div>                   
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <select id="" class="form-control" style="width:60%;margin-right: 3px;" disabled>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="" class="form-control"  style="width:92.5%;"value="개발지침.pptx" disabled>
                       </div>
                   </div>
                   ...
                   <div class="form-group col-md-6">
                       ...
                       <div class="col-sm-8">
                           <input type="text" id="" class="form-control"  style="width:40%; margin:2px 5px 0 0;" value="홍길동" disabled>
                       </div>
                   </div>
                    ...
                    <div class="form-group col-md-3">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">성명</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control"  style="width:80%;" value="홍길동" disabled>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">절감시간(hour)</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control" style="width:40%; margin:2px 5px 0 0;" value="132" disabled>  
                        </div> 
                    </div>   
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-12 py-sm-1 line-footer">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="" class="form-control text-warning" style="width:40%; margin:2px 5px 0px 2px;" value="264" disabled>   
                            </div>
                        </div> 
                    </div> 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control" style="width:40%; margin:2px 5px 0 0;" value="70" disabled>  
                        </div> 
                    </div>   
                    ...
                    <div class="form-group col-md-6">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">기여도(%)</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control" style="width:40%; margin:2px 5px 0 0;" value="30" disabled>  
                        </div> 
                    </div>
                    ...
                    <div class="form-group col-md-12 py-sm-1 line-footer">
                        ...
                        <div class="form-group col-md-6"> 
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="" class="form-control float-left text-warning" style="width:40%; margin:2px 5px 0 2px;" value="100" disabled>   
                            </div>
                         </div> 
                    </div> 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:50%; margin:2px 5px 10px 0;" value="30" disabled> <input type="button" class="btn btn-outline-primary float-left" id="" name="" value="다운로드" />
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="managtChargerId" class="col-sm-4 col-form-label">실행구분</label>
                        <div class="col-sm-8">
                           <select id="" class="form-control" style="width:40%;margin-right: 3px;" disabled>
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:50%; margin:2px 5px 10px 0;" value="정기실행" >
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="managtChargerId" class="col-sm-4 col-form-label">실행계획</label>
                        <div class="col-sm-8">
                           <input type="text" id="" class="form-control float-left" style="width:50%; margin:2px 5px 10px 0;" value="매주 월요일 03:00" > 
                        </div>
                    </div> 
                    ...
                    <div class="form-group col-md-6">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">실행구분</label>
                        <div class="col-sm-8">
                            <input type="text" id="" class="form-control float-left" style="width:50%; margin:2px 5px 10px 0;" value="예약실행" >
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="managtChargerId" class="col-sm-4 col-form-label">실행계획</label>
                        <div class="col-sm-8">
                           <input type="text" id="" class="form-control float-left" style="width:50%; margin:2px 5px 10px 0;" value="2020-08-10 13:00" > 
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <select id="" class="form-control" style="width:40%;margin-right: 3px;">
                ...
                <div class="float-right py-sm-2">
                    <button type="button" class="btn btn-primary" id="unmanagtErrorDetailUpdateBtn">운영취소요청</button>
                    <button type="button" class="btn btn-primary" id="unmanagtErrorDetailUpdateBtn">중지</button>
                    <button type="button" class="btn btn-primary" id="unmanagtErrorDetailUpdateBtn">예약실행</button>
                    <button type="button" class="btn btn-primary" id="unmanagtErrorDetailUpdateBtn">정기실행</button>
