                ...
                <div id="content">
					                ...
					                <div class="card-header" id="insert">
					                    <form class="form-inline">
	                                        <div class="form-group col-md-6">
	                                            <label for="searchCombo2"  class="col-form-label col-sm-3">요청회사</label>
	                                            <div class="col-sm-9">
	                                        ...
	                                        <div class="form-group col-md-6">
	                                            <label for="searchCombo2" class="col-form-label col-sm-3">요청자</label>
	                                            <div class="col-sm-9">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="searchCombo2" class="col-form-label col-sm-3">제목</label>
                                                <div class="col-sm-9 float-left">
                                                    <input type="text" class="form-control float-left" id="hlpdskSearch" placeholder="" style="" value="" />                                                     
					...
					<script>
					    ...
					    function getHlpdskList(cudPage){        
					        var url = "/hlpdsk/requst/getreceipthlpdsk";
					    ...
					    function drawGrid(data){
					        ...
					        $("#answerSearchGrid").jsGrid({
					            ...
					            fields : [ 
					                ...
					                {name: "userNm" ,title : "요청자명", type : "text", width : 60, align:"center"},
					                ...
					                {name: "requstSj" ,title : "제목", type : "text", width : 150, align:"center"}, 
					    ...
					    function detailPageMove(requstSn){
					    	$('.card-header').hide();
					        $('.card-body').hide();
					        var url = "/hlpdsk/requst/hlpdskReceiptDetail";
