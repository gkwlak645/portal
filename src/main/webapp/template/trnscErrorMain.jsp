        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Transaction오류관리</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-header">
                                    <form class="form-inline">  
                                        <div class="form-group col-md-6 py-sm-1">
                                              <span class="col-sm-4">
                                                  <input type="radio" name="chkDe" id="occrrncDe" value="occrrncDe" style="margin-left:0;" checked>발생일  &nbsp; 
                                                  <input type="radio" name="chkDe" id="managtDe" value="managtDe" style="margin-left:0;">조치일
                                              </span>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group row float-left">
                                                    <select id="processCd" class="form-control"class="form-control float-left"  style="min-width: 100px;width:30%;margin-right:10px;">
                                                      <option value=""></option>
                                                    </select>
                                                    <span for="chkOverYN" class="col-form-label float-left text-success"><input type="checkbox" class="custom-checkbox" id="chkOverYN" style="width:18px;height:18px;"/> 중복포함</span>
                                                </div>
                                            </div>
                                        </div>
				...
				$(document.body).ready(function () {    
				    ...
				    function drawGrid(data){
				        ...
				        $("#trnscErrorGrid").jsGrid({
				            ...
				            , fields : [
				                ...
				                , {name: "tyNm"             , title : "오류유형"          , type : "text"    , width : 120, align : "center"}
				                , {name: "processSn"        , title : "프로세스코드"       , type : "text"   , width : 80, align : "center"}
				                , {name: "errorUnitySn"     , title : "통합아이디"        , type : "text"   , width : 80, align : "center"}
				                , {name: "trnscErrorSn"     , title : "아이디"            , type : "text"   , width : 70, align : "center"}
				                , {name: "reprsntAt"        , title : "대표여부"           , type : "text"   , width : 70, align : "center"}
				                , {name: "occrrncDe"        , title : "발생일"            , type : "text"   , width : 80, align : "center"}
				                , {name: "occrrncHm"        , title : "발생시간"           , type : "text"   , width : 70, align : "center"}
				    ...
				    function searchTrnscErrorList(pageNo) {
				    	...
				    	if($("#startDe").val() > $("#endDe").val()){
				            ...
				            var param = {
				                  cmpnyCd               : $("#cmpnyCd").val()
				                , chkDe                 : $('input:radio[name="chkDe"]:checked').val()
