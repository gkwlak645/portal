        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">정기실행 계획등록</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
...
<!--  템플릿 바디 -->        
 <div class="card card-primary" id="unmanagtErrorRegDiv">                   
    <div class="card-header" alt="과제 >과제운영>정기실행 계획등록">
        <h3 class="card-title">정기실행 계획</h3>
    </div>
    <div class="card-body">
            ...
            <div class="col-md-12">
                <form class="form-inline" id="unmanagtErrorDetail">                    
                    <div class="form-group col-md-12  py-sm-1">
                        <div class="col-sm-4 float-left"><h5 class="text-success float-left">⊙ 실행기간</h5></div>
                        <div class="col-sm-8 float-right">    
                             <div class="col-sm-10  float-right">                            
                                <div class="input-group date float-right" id="endDeDiv" data-target-input="nearest"style="width:34%; max-width:270px;min-width:150px;margin: 0 0 2px 0;">
                                     &nbsp;~ &nbsp; <input type="text" id="endDeDiv" name="endDeDiv" class="form-control datetimepicker-input" data-target="#startDeDiv"value="2020-08-05"/>
                                     <div class="input-group-append" data-target="#endDeDiv" data-toggle="datetimepicker">
                                         <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                     </div>
                                 </div>
                                 <div class="input-group date float-right" id="startDeDiv" data-target-input="nearest"style="width:32%; max-width:220px;min-width:150px;margin: 0 5px 2px 0;"> 
                                     <input type="text" id="startDe" name="startDe" class="form-control datetimepicker-input" data-target="#startDeDiv"value="2020-07-05"/>
                ...
                <div class="float-right py-sm-2">
                    <button type="button" class="btn btn-primary" id="unmanagtErrorDetailUpdateBtn">적용</button>
