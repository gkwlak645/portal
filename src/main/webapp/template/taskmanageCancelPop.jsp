        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-0">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">과제운영 취소</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <form class="form-inline" id="unmanagtErrorDetail">                    
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <select id="" class="form-control" style="width:80%;margin-right: 3px;" type="text" disabled>
                    ...
                    <div class="form-group col-md-12">
                        <label for="errorTyCd" class="col-sm-2 col-form-label">최소사유</label>
                        <div class="col-sm-10">
                            <input type="text" id="" class="form-control"  style="width:92.5%;"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-12 py-sm-1">
                        <label for="errorCn" class="col-sm-2 col-form-label">처리사항</label>
                        <div class="col-sm-10">
