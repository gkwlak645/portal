            ...
            <div class="card">
                <div class="card-body">
                    <div class="cus_table-wrap">
                        ...
                        <table class="cus_table" id="procStsList" style="table-layout: fixed;overflow:hidden;">
                            <colgroup>
...
function searchList() {
    ...
    // year 선택 조회
    if(radioVal=="Y"){
        var url = '/stats/processExecutStatus/processExecutStatusYearListV2';
        var param = {searchYear: $("#searchYear").val(), searchCmpnyCd:$("#searchCmpnyCd").val()}; 
        callAsyncAjax(url, param, "yearDrawData");
    }else{
        // month 선택 조회
        var url = '/stats/processExecutStatus/processExecutStatusMonthListV2';
	...
	for(var j = 0; j < aResultLen ; j++){
	   ...
	   if(rowNo == 0 ){
		   if(aResult[j].compCd != "ZZ"){
			    ...
			    str += '<th rowspan="8">'+aResult[j].processCd+'</th>';
			    str += '<th rowspan="8">'+aResult[j].processNm+'</th>';
		   }else{
...
function monthDrawData(data){
    ...
    // col group 비율 설정
    var strrr = "";
    strrr += '<col width="60px">';
    strrr += '<col width="60px">';
    strrr += '<col width="80px">';
    strrr += '<col width="60px">';
    strrr += '<col width="60px">';
