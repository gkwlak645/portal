...
<div class="card card-primary" id = "cardDiv" style="width:101%; height:100%; overflow-y:scroll;">
    <div class="card-header">
        <h3 class="card-title">등록</h3>
    </div>
    <div class="card-body" alt="커뮤니티>공지사항 등록" style="width:100%; min-height:350px; overflow:hidden;">
        <div class="row" style="overflow-y:scroll;">
            <div class="col-md-12">
                <div class="form-inline">
                     ...
                     <div style="margin: 0.25rem 0 0.1rem 0;">
                         <label  class="col-sm-2 col-form-label">내용</label>
                         <div class="col-sm-10" class="boardContent" style="padding-left: 4px;"id="summernote"></div>
                     </div>
               
                     <div class="form-group col-md-12 py-sm-2" style="margin: 0.25rem 0 0.1rem 0;">
                         <label  class="col-sm-2 col-form-label">첨부파일</label>
                         <div class="col-sm-10"style="padding-left: 4px;" id="fileUpload"></div>
                    </div>
                </div>
            </div>
