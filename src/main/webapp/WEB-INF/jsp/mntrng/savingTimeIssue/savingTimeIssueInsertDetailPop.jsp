...
$(document).ready(function() {
	...
	function insertResn() {	
		...
		var url = "/mntrng/savingTimeIssue/insertSavingTimeIssueResn";
		var userId = "${txUserId}";
		...
		*/
        ...
        callAsyncAjax(url, param, "insertSavingTimeResnCallback");
    ...
    function insertSavingTimeResnCallback(){
        alert("등록 완료되었습니다.");       
        closePOP();
        // 로딩 끝
