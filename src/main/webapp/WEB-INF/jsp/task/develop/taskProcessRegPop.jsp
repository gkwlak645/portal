            ...
            <div class="col-md-12">
                <form class="form-inline" id="unmanagtErrorDetail">                    
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" id="processNo" class="form-control"  style="width:80%;">
                            <input type="text" id="processCd" class="form-control"  style="width:80%;" maxlength="6" numberEnglish>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="10" id="jobDc" class="form-control" style="width:92.5%;height:50%;" maxlength="2000"></textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
...
<%--                     
                    ...
                    <div class="form-group col-md-6">
                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label float-left">업무시간<b style="color:red;padding-left:10px;">*</b></label>
                        <div class="col-sm-8">
...
--%>
                    ...
                    <div class="form-group col-md-6">
                        <label for="devlopChargerNm" class="col-sm-4 col-form-label">개발담당자<b style="color:red;padding-left:10px;">*</b></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="executSe" class="col-sm-4 col-form-label">실행구분<b style="color:red;padding-left:10px;">*</b></label>
                        <div class="col-sm-8 float-left">
                            <select id="executSe" class="form-control" style="width:80%;margin-right: 3px;"></select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="belongingDe" class="col-sm-4 col-form-label">개발귀속일<b style="color:red;padding-left:10px;">*</b></label>
                        <div class="col-sm-4">
...
--%>
	               ...
	               <div class="form-group col-md-12" id="chargerList">                                     
	                    <div class="form-group col-md-6" name="chargerList0">
			            <label for="sourcUpdtNm" class="col-sm-4 col-form-label">부서</label>
			            <div class="col-sm-8 jq_chargerDept">
			                <input type="hidden" id="chrgDeptCd0" class="form-control"  style="width:80%;" readonly>
			                <input type="text" id="chrgDeptNm0" class="form-control"  style="width:80%;" readonly>
			            </div>
			            </div>
			            <div class="form-group col-md-6" name="chargerList0">
			                <label for="sourcUpdtNm" class="col-sm-4 col-form-label">성명</label>
			                <div class="col-sm-8 jq_chrgUser">
			                    <input type="hidden" id="chrgUserId0" class="form-control float-left"  style="width:30%; margin:2px 5px 0 0;" readonly>
			                    <input type="text" id="chrgUserNm0" class="form-control float-left"  style="width:30%; margin:2px 5px 0 0;" readonly>
			                    <input type="button" class="btn btn-outline-primary float-left" id="" name="btnSearchUser" onclick="searchUserV2('chrg', 0)" value="사원검색" />
			                    <input type="button" class="btn btn-outline-secondary float-left" id="" name="" onclick="popDeleteList('chargerList', 0)" value="삭제" />
			                </div>
			            </div>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-12" id="individualRedcnTmList">
	                     <div class="form-group col-md-3" name="individualRedcnTm0">
	                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">부서</label>
	                        <div class="col-sm-8 jq_redcnTmDept">
	                            <input type="hidden" id="redcnTmDeptCd0" class="form-control">
	                            <input type="text" id="redcnTmDeptNm0" class="form-control"  style="width:75%;" readonly>
	                        </div>
	                    </div>                    
	                    <div class="form-group col-md-4" name="individualRedcnTm0">
	                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">성명</label>
	                        <div class="col-sm-8 jq_redcnTmUser">
	                           <input type="hidden" id="redcnTmUserId0" class="form-control float-left"  style="width:48%;margin:2px 5px 0 0;" readonly>
	                            <input type="text" id="redcnTmUserNm0" class="form-control float-left"  style="width:48%;margin:2px 5px 0 0;" readonly>
	                            <input type="button" class="btn btn-outline-primary float-left" id="" name="" onclick="searchUserV2('redcnTm', 0)" value="사원검색" />
	                        </div>
	                    </div>
	                    <div class="form-group col-md-5" name="individualRedcnTm0">
	                        <label for="sourcUpdtNm" class="col-sm-4 col-form-label">절감시간(hour)</label>
	                        <div class="col-sm-8 float-left">
	                            <input type="text" id="redcnTmRedcnTm0" class="form-control float-left jq_redcnTmRedcnTm" style="width:48%; margin:2px 5px 0 0;" value="">
	                            <input type="button" class="btn btn-outline-secondary float-left" id="" name=""  onclick="popDeleteList('individualRedcnTm', 0)" value="삭제" /> 
	                        </div> 
	                    </div>   
	                 </div>
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-12" id="individualContributeList">
	                     <div class="form-group col-md-3" name="individualContributeList0">
                            <label for="sourcUpdtNm" class="col-sm-4 col-form-label">부서</label>
                            <div class="col-sm-8 jq_contributeDept">
                                <input type="hidden" id="contributeDeptCd0" class="form-control">
                                <input type="text" id="contributeDeptNm0" class="form-control"  style="width:80%;" readonly>
                            </div>
                        </div>                    
                        <div class="form-group col-md-4" name="individualContributeList0">
                            <label for="sourcUpdtNm" class="col-sm-4 col-form-label">성명</label>
                            <div class="col-sm-8 jq_contributeUser">
                                <input type="hidden" id="contributeUserId0" class="form-control">
                                <input type="text" id="contributeUserNm0" class="form-control float-left"  style="width:48%;margin:2px 5px 0 0;" readonly>
                                <input type="button" class="btn btn-outline-primary float-left" id="" name="" onclick="searchUserV2('contribute', 0)" value="사원검색" />
                            </div>
                        </div>
                        <div class="form-group col-md-5" name="individualContributeList0">
                            <label for="sourcUpdtNm" class="col-sm-4 col-form-label">기여도(%)</label>
                            <div class="col-sm-8 float-left">
                                <input type="text" id="contributeRate0" class="form-control float-left jq_contributeRate" style="width:48%; margin:2px 5px 0 0;">
                                <input type="button" class="btn btn-outline-secondary float-left" id="" name="" onclick="popDeleteList('individualContributeList', 0)" value="삭제" />
                            </div>  
                        </div>
                    </div>
                ...
                <div class="float-right py-sm-2">
                    <button type="button" class="btn btn-primary" id="temporaryBtn">임시저장</button>
                    <button type="button" class="btn btn-primary" id="registerBtn">결재요청</button>
...
<!-- 로딩바  -->
<div id="taskPaymentDiv" class="dimmed" style="display:none"></div>
<div id="taskPaymentLoading" class="loading" style="display:none">
...
<form name="PassFormDraft" method="post" target="_blank">
    ...
    <input type="hidden" id="formPrefix" name="formPrefix" value="Z_20_001_04">
    <input type="hidden" id="legacyout" name="legacyout" value='<?xml version="1.0"?><XML_DATA><apprvReqNo>826361</apprvReqNo><formPrefix>Z_20_001_04</formPrefix></XML_DATA>' />       
    <input type="hidden" id="bodytype" name="bodytype" value="html">
</form>

<script>

var isTemporary = false; //임시 저장 여부
...
$(document).ready(function() { 
    ...
    function bindEvent() { 
    	...
    	$("#btnAddCharger").on('click', function(){
	        ...
	        str += '        <input type="button" class="btn btn-outline-primary float-left" id="" name="btnSearchUser" onclick="searchUserV2(\'chrg\', '+ chargerCnt + ')" value="사원검색" />'
	        str += '        <input type="button" class="btn btn-outline-secondary float-left" id="" name="" onclick="popDeleteList(\'chargerList\', '+ chargerCnt + ')" value="삭제" />'
	        str += '    </div>'
	        str += '</div>'
    	...
    	$("#btnAddIndividualRedcnTm").on('click', function(){
			...
			str += '         <input type="hidden" id="redcnTmDeptCd'+ individualConCnt + '" class="form-control">'
			str += '         <input type="text" id="redcnTmDeptNm'+ individualConCnt + '" class="form-control"  style="width:75%;" readonly>'
			str += '     </div>'
			str += ' </div>'                    
			str += ' <div class="form-group col-md-4" name="individualRedcnTm'+ individualConCnt + '">'
			str += '     <label for="sourcUpdtNm" class="col-sm-4 col-form-label">성명</label>'
			str += '     <div class="col-sm-8 jq_redcnTmUser">'
			str += '         <input type="hidden" id="redcnTmUserId'+ individualConCnt + '" class="form-control float-left"  style="width:48%;margin:2px 5px 0 0;" readonly>'
			str += '         <input type="text" id="redcnTmUserNm'+ individualConCnt + '" class="form-control float-left"  style="width:48%;margin:2px 5px 0 0;" readonly>'
			str += '         <input type="button" class="btn btn-outline-primary float-left" id="" name="" onclick="searchUserV2(\'redcnTm\', '+ individualConCnt + ')" value="사원검색" />'
			str += '     </div>'
			str += ' </div>'
			...
			str += '         <input type="text" id="redcnTmRedcnTm'+ individualConCnt + '" class="form-control float-left jq_redcnTmRedcnTm" style="width:48%; margin:2px 5px 0 0;">'
			str += '         <input type="button" class="btn btn-outline-secondary float-left" id="" name=""  onclick="popDeleteList(\'individualRedcnTm\', '+ individualConCnt + ')" value="삭제" />' 
			str += '     </div>'
			str += ' </div>'
        ...
        $("#btnAddIndividualContribute").on('click', function(){
            ...
            str += '        <input type="button" class="btn btn-outline-primary float-left" id="" name="" onclick="searchUserV2(\'contribute\', '+ individualConCnt + ')" value="사원검색" />'
            str += '    </div>'
            str += '</div>'
            ...
            str += '        <input type="button" class="btn btn-outline-secondary float-left" id="" name="" onclick="popDeleteList(\'individualContributeList\', '+ individualConCnt + ')" value="삭제" />'
            str += '    </div>  '
            str += '</div>'
    	...
    	$("#registerBtn, #temporaryBtn").on("click", function() {
    		var oThis = $(this)
    		var sEventId = oThis.attr("id");
            ...
            else if($.trim(oProcessCd.val()).length != 6){
                alert("프로세스코드는 6자리입니다.");
                oProcessCd.focus();
                return false;
            }
            
            else if((oProcessCd.val()).substring(0,4) != $("#taskCd option:checked").text())
            {
                alert("프로세스코드의 앞 4자리는 과제코드와 동일해야 합니다.");
                oProcessCd.focus();
                return false;
            }
...
//            }
            ...
            if(iChk < 1){
            	alert("담당자 정보 > 1명 이상의 담당자 정보를 입력해 주십시오.")
            	return false;
            }
            ...
            for(var i = 0; i < iaRedcnTmDeptCd; i++){
                ...
                if(oTemp01.val() != "" && oTemp02.val() == ""){
                	alert("개인별 절감시간 > 절감 시간을 입력해 주십시오.")
                	oTemp02.focus();
                	return false;
                }else if(oTemp01.val() == "" && oTemp02.val() != ""){
                    alert("개인별 절감시간 > 사원 정보를  입력해 주십시오.")
                    return false;
                }
                else if(oTemp01.val() != "" && oTemp02.val() != ""){
                	aRedcnTmList.push({
...
*/            
            ...
            for(var i = 0; i < iaContributeDeptCd; i++){
                ...
                if($(aContributeDeptCd[i]).val() != ""){
                    iChk ++
                }
                
                if(oTemp01.val() != "" && oTemp02.val() == ""){
                    alert("개인별 기여도 > 기여도를 입력해 주십시오.");
                    setTimeout(function(){oTemp02.focus()}, 500);
                    return false;
                }else if(oTemp01.val() == "" && oTemp02.val() != ""){
                    alert("개인별 기여도 > 사원 정보를  입력해 주십시오.");
                    return false;
                }
                else if(oTemp01.val() != "" && oTemp02.val() != ""){
            ...
            if(iFileGrpNo == 0){
                alert("첨부파일 > 업무기술서를 첨부해주십시오.");
                return false;
            }
            
            if(sEventId != "temporaryBtn"){//결재 요청
...
--%>
			    ...
			    /* 프로세스 결재용 추가 파라미터 */
			    ,    pCmpnyNm: $("#cmpnyCdReg option:selected").text()
			    //,    pJobClsCd: $("#clsCd option:selected").text()
                //,    pRpaClsCd: $("#rpaClsCd option:selected").text()
			    //,    pJobTm: oProcessJobTm.val()
			    ,    pRedcnTm: oRedcnTm.val()
			    ,    pExpectRedcnAmt: oExpectRedcnAmt.val()
			    ,    pFqCd: $("#fqCdReg option:selected").text()
			    ,    pExecutCnt: oExecutCntReg.val()
			    ,    pExecutTm: oExecutTm.val()
			    ,    pRto: $("#rto").val()
			    ,    pDevlopWdcnt: oDevlopWdcnt.val()
                ,    pExpectDevlopCt: expectDevlopCt.val()
                ,    pInsideDevlopAt: $("#insideDevlopAt option:selected").text()
                ,    formPrefix:"Z_20_001_04"
            }

            if(sEventId == "temporaryBtn"){//임시저장
            	callAsyncAjax("/task/develop/insertTaskDevelopProcess", param, "mainPopCloseReload");
            }
            else{//결재하기
            	param.pTemporary = false;
                if(isTemporary){
                	callAsyncAjax("/task/develop/updateTaskDevelopProcess", param, "callPaymentForm");
                }else{
                	callAsyncAjax("/task/develop/insertTaskDevelopProcess", param, "callPaymentForm");
                }
            }
    ...
    function pageInit(){
        bbsUpload = new RpaUploadV2("fileUpload");
        bbsUpload.draw('',true);
    }
    
    function getUserInfo(){
        var params = {jobChargerNm: $("#jobChargerId").val()};
        callAsyncAjax("/task/develop/getUserInfo", params, "getUserInfoCallback");
    }
    
    function getUserInfoCallback(data){
        $("#emailAdr").val(data.result.emailAdr);
        $("#telno").val(data.result.telno);
    }
    ...
    function callPaymentForm(data){ 
	    ...
	    //결재 로딩바 
        $('#taskPaymentDiv').css({ display: 'block' });
        $('#taskPaymentLoading').css({ display: 'block' });
        $('#taskPaymentLoading').addClass('show');
    ...
    function callBackChkTaskPaymentApiResponse(data){
        ...
        if(processSttus == "P1"){
            //개발 결재중 : 정상 (P1) -> 팝업닫기
            alert('프로세스 결재가 상신되었습니다.');
            mainPopCloseReload();
        }else{
            //계속 임시저장(P4)일 경우 프로세스 결재 임시저장 처리 -> 팝업 계속 유지 로딩바 삭제
            $('#taskPaymentDiv').css({ display: 'none' });
            $('#taskPaymentLoading').css({ display: 'none' });
            $('#taskPaymentLoading').removeClass('show');
        }
    }
    ...
    function callBackChkTaskPaymentApiResponseASIS(data){
        ...
        if((processSttus == null || processSttus == "" || processSttus == "P4") && 3 > chkCount){
        	//개발 결재 대기중 일 경우 3번 체크
        	chkTaskPaymentApiResponse(data);
        }else if(processSttus == "P1"){
        	//개발 결재중 : 정상 (P1) -> 팝업닫기
    		mainPopCloseReload();
    	}else{
    		//계속 개발 결재 대기중(P4)일 경우 프로세스 결재 삭제 처리
    ...
    function taskPaymentRollBack(data){
    	console.log("삭제");
    	console.log(data.result);
        var url = '/task/payment/requestTaskPaymentRollBack';
