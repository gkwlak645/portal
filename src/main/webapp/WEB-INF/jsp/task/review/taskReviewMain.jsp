...
<div id="taskReviewMainDiv" class="container-fluid wrap">
    <div class="row">
        <div class="col-md-12" alt="과제 >과제검토">
            <div class="card">
                <div class="card-header">
                    <form class="form-inline py-sm-2">
                        ...
                        <div class="form-group col-md-12 py-sm-2" style="margin: 0.25rem 0.1rem 1rem 0.1rem;min-width: 460px;" >
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div id="taskReviewGrid"></div>
                    <div id="taskReviewGridPager" class="portal-pager"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function drawGrid(data){
        ...
        if (data != null && data != undefined) {
            ...
            drawPager("taskReviewGridPager", data.result.paginationInfo, "searchTaskReviewList");
        }
        $("#taskReviewGrid").jsGrid({
              height : "auto"
            , width : "100%"
            , autoload: true
            , sorting : true
            ...
            , rowClick: function(arg){
            	popupTaskReviewDetail(arg.item.taskNo);
            }
            , fields : [
     ...
     * @return
     */
    function searchTaskReviewList(pageNo) {
        ...
        var url = '/task/review/getTaskReviewList';
        var currentPageNo = 1;
     ...
     * @return
     */
    function popupTaskReviewDetail(taskNo) {
        appendDetailPopup("taskReviewMainDiv", "/task/review/taskReviewDetailPop");
        getTaskReviewDetail("/task/review/getTaskReviewDetail", taskNo);   
    }
     ...
     * @return
     */
    function getTaskReviewDetail(url, taskNo) {
        var param = {"taskNo" : taskNo};
        callAsyncAjax(url, param, "printTaskReviewDetail");
    }
